...
public class DataLoadConfig {
    ...
    public void loadRole() {
        ...
        admin.setEmail("destructeurkratos@gmail.com");
        admin.setName("Super Administrateur");
        admin.setUsername("destructeurkratos@gmail.com");
